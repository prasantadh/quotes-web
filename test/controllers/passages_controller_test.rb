...
class PassagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create passage" do
    assert_difference('Passage.count') do
      post passages_url, params: { passage: { context: @passage.context, passage: @passage.passage } }
    end
  ...
  test "should update passage" do
    patch passage_url(@passage), params: { passage: { context: @passage.context, passage: @passage.passage } }
